...
assert.match(page, /My previous assessments/);
assert.match(page, /\/api\/talentedge\/assessments/);
assert.match(page, /function loadCandidateHistory/);
assert.match(app, /def _save_talentedge_assessment/);
assert.match(app, /def _admin_talentedge_assessments/);
assert.match(app, /def _list_talentedge_assessments/);
